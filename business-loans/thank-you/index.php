        ...
        <div class="cards w-75 mx-auto">
          <div class="card text-center bg-light mb-4">
            <div class="card-body py-5">
              <h6 class="card-text font-weight-bold">Recommended Next Step:</h6>
              <h2 class="card-title">Need to save money on your business utility bill?</h2>
              <p class="card-text mb-0">We compare the UK's best business gas and electricity providers to find you the best deal</p>
              <p class="card-text">Check out what you could save today and slash your monthly bills!</p>
              ...
              <div class="col-lg-6 mx-auto mb-4">
                <div class="card">
                  <div class="card-body text-center">
                    ...
                    <h5 class="card-title">Business Energy Savings</h5>
                    <a href="<?php echo $domain; ?>/business-energy" class="btn btn-main stretched-link">Get Quote</a>
                  </div>
                </div>
              </div>
