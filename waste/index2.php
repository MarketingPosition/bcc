...
<body>
    ...
    <div class="container h-100">
      <div class="row no-gutters">
        <div class="hero__title">
          <h1>Business Waste Collections<span id="location"></span></h1>
        </div>
      </div>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-8 mx-auto">
            ...
            <form id="pform" action="<?php echo $domain; ?>/form/lead-waste-sf-ng.php" method="post">
  ...
  <script src="<?php echo $domain; ?>/assets/js/form-waste2.js" defer></script>
