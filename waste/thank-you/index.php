...
$page_name = "Thank You - Business Cost Comparison";
$section_name = "";
$page_description = "";
        ...
        <div class="row">
          <div class="col-12 col-lg-8 mx-auto text-center">
            <div class="thank-you-message">
              ...
              <p>Once we have verified your details, our recommended partner will contact you within 24 hours to discuss your requirements.</p>
              <p>
                As Business Waste is a very complex industry we may require more information from you. Because of this we cannot serve an accurate quotation instantly, therefore you will be contacted by one of our trusted partner consultants who will find you the best deal for your needs, saving you more money on your own time and resource, whilst being checked and vetted by ourselves for the best service
              </p>
            </div>
          </div>
        </div>
        <div class="cards w-75 mx-auto">
          <div class="card text-center bg-primary mb-4">
            <div class="card-body py-5">
              <h3 class="card-text h2 font-weight-bold text-white"><em>NEXT STEP:</em></h3>
              <h2 class="card-title text-white">Save up to 40% on your business utility bill</h2>
              <p class="card-text text-white">Switching providers could have you saving money each month on your business electricity and gas. Let's take a look at what you could save...</p>
            ...
            <div class="col-lg-12 mb-4">
              <div class="card">
                <div class="card-body text-center">
                  ...
                  <h5 class="card-title">Have You Considered Business Healthcare?</h5>
                  <p>Want to do more for your employees? We help hundreds of small, medium and corporate sized businesses. by providing no obligation quotations on private healthcare insurance and healthcare solutions.</p>
          ...
          <div class="text-center pt-4">
            ...
            <p class="mb-3">You could also save even more on your business costs with our other services too!</p>
                ...
                <div class="card">
                  <div class="card-body text-center">
                    <div class="products__item__image bg-primary">
                      ...
                      <noscript><img src="<?php echo $domain; ?>/assets/images/waste-icon.svg" alt="Business Waste Collection" title="Business Waste Collection" width="35" /></noscript>
                      <img data-src="<?php echo $domain; ?>/assets/images/waste-icon.svg" alt="Business Waste Collection" title="Business Waste Collection" width="35" class="lazyload blur-up" />


                    </div>
                    <h5 class="card-title">Business Waste Collection</h5>
                    <a href="<?php echo $domain; ?>/waste" class="btn btn-main stretched-link">Get Quote</a>
                  </div>
                </div>
              </div>
              ...
              <div class="col-lg-6 mx-auto mb-4">
                <div class="card h-100">
                  <div class="card-body text-center">
                    ...
                    <h5 class="card-title">Business Card Payment Solutions</h5>
