...
$page_name = "Dry Recycling - Business Cost Comparison";
$section_name = "";
$page_description = "";
    ...
    <div class="container h-100">
      <div class="row no-gutters">
        <div class="hero__title">
          <h1>Dry Recycling Waste Collection<span id="location"></span></h1>
        </div>
      </div>
          ...
          <div class="steps__item">
            <div class="steps__item__content">
              ...
              <div class="steps__item__title">
                ...
                <p>Over the phone or via email in minutes, after you get your quote</p>
              </div>
            </div>
          </div>
