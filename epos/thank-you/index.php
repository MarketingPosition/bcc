...
<![endif]-->
  ...
  <main id="content">
    ...
    <section class="single-column">
      <div class="container">
        <div class="w-75 mx-auto mb-5 text-center">
          <div class="thank-you-message bg-primary p-5">
            <h2 class="card-title text-white">Good News! You’re Just One Step Away From EPOS Heaven.</h2>
            <p class="text-white mb-0">An experienced business expert will give you a call shortly.</p>
            <p class="text-white mb-0">There’s just a couple more details we need, which we’ll grab over the phone. It looks like we’re going to be able to sort you out with a fantastic EPOS package to fit your needs perfectly.</p>
            <p class="text-white mb-0">Make sure you’ve got your phone handy, and expect a call in the next few minutes - or in the morning, if it’s late!</p>
          </div>
        </div>
