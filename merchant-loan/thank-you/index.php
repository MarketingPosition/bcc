        ...
        <div class="row">
          <div class="col-12 col-lg-8 mx-auto text-center">
            <div class="thank-you-message">
              ...
              <p>
                As Loans is a very complex industry we may require more
                information from you. Because of this we cannot serve an
        ...
        <div class="cards w-75 mx-auto">
          <div class="card text-center bg-light mb-4">
            <div class="card-body py-5">
              ...
              <h2 class="card-title">
                Need to save money on your business utility bill?
              </h2>
              <p class="card-text mb-0">
                We compare the UK's best business gas and electricity
                providers to find you the best deal
              </p>
              <p class="card-text">
                Check out what you could save today and slash your monthly
                bills!
              </p>
