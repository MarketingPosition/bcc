...
pform.validate({
  ...
  errorPlacement: function(error, element) {
   if (element.attr("name") == "using_fuel")
       error.appendTo(".fuel_q1_container");
   else if (element.attr("name") == "fuel_type")
       error.appendTo(".fuel_q2_container");
   else if (element.attr("name") == "vehicles")
       error.appendTo(".fuel_q3_container");
   else if (element.attr("name") == "type_vehicle")
       error.appendTo(".fuel_q4_container");
   else if (element.attr("name") == "company_type")
       error.appendTo(".fuel_q5_container");
   else if (element.attr("name") == "spend")
       error.appendTo(".fuel_q6_container");
   else
