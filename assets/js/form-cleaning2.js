...
pform.validate({
  ...
  errorPlacement: function (error, element) {
    ...
    else if (element.attr("name") == "currently_paying")
      error.insertAfter(".currently_paying_container");
...
function nextPrev(n) {
  var r_val = $('input[name="energy_type"]:checked').val();
  ...
  console.log(currentTab + "==" + r_val + "===" + n);
  x[currentTab].style.display = "none";
  if (r_val == "No" && currentTab == 3 && n == -1) {
    currentTab = 1;
    x[currentTab].style.display = "none";
  }
  if (r_val == "No" && currentTab == 0 && n == 1) {
    currentTab = 2;
    x[currentTab].style.display = "none";
  }
  if (r_val == "Yes" && currentTab == 1 && n == 2) {
    n = 1;
    //x[currentTab].style.display = "none";
  }
