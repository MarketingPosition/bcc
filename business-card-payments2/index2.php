...
<body>
  ...
  <noscript>
    <iframe src="https://www.googletagmanager.com/ns.html?id=GTM-N9N73MT" height="0" width="0" style="display: none; visibility: hidden"></iframe>
  </noscript>
        ...
        <div class="row align-items-center">
          <div class="col d-flex justify-content-md-end">
            ...
            <div class="usp-banner__item">
              ...
              <p>Get The Lowest Transaction Fee %</p>
            </div>
            <div class="usp-banner__item">
  ...
  <main id="content">
      ...
      <div class="container h-100">
        <div class="row no-gutters">
          <div class="hero__title">
            <h1>Compare Business Card Terminals</h1>
          </div>
        </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-8 mx-auto">
            <form id="pform" action="<?php echo $domain; ?>/form/lead-merchant2.php" method="post">
              ...
              <input type="hidden" name="redirect_url" value="<?php echo $domain; ?>/business-card-payments2/thank-you/" />
    ...
    <section class="steps" style="padding-bottom: 0px">
      <div class="container">
        <div class="col-12">
          <div class="logos-slider slick-slider">
            <div>
              <img src="/assets/images/card/visa.svg" class="img-fluid" />
            </div>
            <div>
              <img src="/assets/images/card/mastercard.svg" class="img-fluid" />
            </div>
            <div>
              <img src="/assets/images/card/contactless.svg" class="img-fluid" />
            </div>
            <div>
              <img src="/assets/images/card/maestro.svg" class="img-fluid" />
            </div>
            <div>
              <img src="/assets/images/card/applepay.svg" class="img-fluid" />
            </div>
            <div>
              <img src="/assets/images/card/gpay.svg" class="img-fluid" />
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="steps__list row no-gutters">
          <div class="steps__item">
            <div class="steps__item__content">
              <div class="steps__item__image">
                <noscript>
                  <img src="<?php echo $domain; ?>/assets/images/step-icon-1.svg" width="35" />
                </noscript>
          ...
          <div class="steps__item">
            <div class="steps__item__content">
              <div class="steps__item__image">
                <noscript>
                  <img src="<?php echo $domain; ?>/assets/images/step-icon-2.svg" width="35" />
                </noscript>
          ...
          <div class="steps__item">
            <div class="steps__item__content">
              <div class="steps__item__image">
                <noscript>
                  <img src="<?php echo $domain; ?>/assets/images/step-icon-3.svg" width="35" />
                </noscript>
      ...
      <div class="container">
        <div class="row">
          <div class="col-12 col-lg-8 mx-auto text-center">
            ...
            <noscript>
              <img src="<?php echo $domain; ?>/assets/images/logo-bcc-color.svg" alt="BusinessCostComparison" title="BusinessCostComparison" width="136" />
            </noscript>
      ...
      <div class="container">
        <div class="row">
          <div class="col-12 col-md-4 col-lg-2 text-left text-md-center">
            <noscript>
              <img src="<?php echo $domain; ?>/assets/images/tick.svg" alt="Icon" title="Icon" width="44" />
            </noscript>
  ...
  <link rel="stylesheet" type="text/css" href="/assets/css/slick.css" charset="UTF-8" />
  <link rel="stylesheet" type="text/css" href="/assets/css/slick-theme.css" charset="UTF-8" />
  ...
  <!-- End TrustBox script -->
  <script src="https://quoteheroes.co.uk/assets/js/jquery-3.3.1.slim.min.js"></script>
