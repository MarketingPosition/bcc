...
<body>
    ...
    <div class="container h-100">
      <div class="row no-gutters">
        <div class="hero__title">
          <h1>Business Waste<span id="location"></span></h1>
        </div>
      </div>
            ...
            <form id="pform" action="<?php echo $domain; ?>/form/lead-waste-sf.php" method="post">
              ...
              <div id="pformholder">
                ...
                <div id="step5" class="tab">
                  ...
                  <input class="d-none" type="text" name="bottrap" value="" />
                </div>
  ...
  <script src="<?php echo $domain; ?>/assets/js/form-waste-2.js" defer></script>
