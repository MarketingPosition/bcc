        ...
        <div class="cards w-75 mx-auto">
          <div class="card text-center bg-light mb-4">
            <div class="card-body py-5">
              ...
              <h2 class="card-title">Need a Business Loan?</h2>
              <p class="card-text mb-0">Borrow from £3,500 to £150,000+</p>
              <p class="card-text">Unsecured business loans available for all credit scores</p>
              <p>Check your eligibility today > </p>
              <a href="<?php echo $domain; ?>/business-loans" class="btn btn-main">Get Funds</a>
            </div>
          </div>
