        ...
        <div class="cards w-75 mx-auto">
          <div class="card text-center bg-light mb-4">
            <div class="card-body py-5">
              ...
              <h2 class="card-title">Looking For a Card Payment Solution?</h2>
              <p class="card-text mb-0">Bring yourself up to date and offer contactless payments in your business</p>
              <p class="card-text">Start taking card payments effectively</p>
              <p>Get a quote today > </p>
              <a href="<?php echo $domain; ?>/business-card-payments" class="btn btn-main">Get Started</a>
            </div>
          </div>
