 ...
 */
var pp_custom_code_editor_dev, pp_custom_css_js_dev_data = null, pp_custom_css_js_dev_files = [], pp_custom_css_js_dev_file = '', pp_custom_css_js_dev_published_rev = 0, pp_custom_css_js_dev_liveview = false, pp_custom_code_editor_dev_localstorage_dirty = false;
window.localStorage.removeItem('pp_custom_css_liveview_files');
jQuery(document).ready(function($) {
	$.post(ajaxurl, {action: "pp_custom_css_js_dev_load", mode: pp_custom_css_js_dev_mode})
		.done(function(data) {
			if (data.success) {
				...
				$(window).resize();
				$('#pp_custom_css_js_dev_loader_container').fadeOut();
	...
	$('#pp_custom_css_js_dev_page .nav-tab-wrapper').sortable({
		...
		$.post(ajaxurl, {action: "pp_custom_css_js_dev_sort", mode: pp_custom_css_js_dev_mode, 'order': order})
			.fail(function() {
	...
	$("#pp-custom-css-js-dev-delete-revisions-btn").click(function() {
		...
		$.post(ajaxurl, {action: "pp_custom_css_js_dev_delete_revisions", mode: pp_custom_css_js_dev_mode, file: pp_custom_css_js_dev_file})
			.done(function(data) {
				if (data.success) {
	...
	$("#pp_custom_css_js_dev_revisions").on("click", "li > a.view-rev", function(ev) {
		...
		$.post(ajaxurl, {action: "pp_custom_css_js_dev_get_revision", mode: pp_custom_css_js_dev_mode, rev: revId})
			.done(function(data) {
				if (data.success) {
	...
	$("#pp_custom_css_js_dev_revisions").on("click", "li > a.del-rev", function(ev) {
		...
		$.post(ajaxurl, {action: "pp_custom_css_js_dev_delete_revision", mode: pp_custom_css_js_dev_mode, rev: revId})
			.done(function(data) {
				if (data.success) {
					pp_custom_css_js_dev_data[data.data.file].revisions = data.data.revisions;
					pp_custom_css_js_dev_update_revisions();
	...
	$('#pp_custom_css_js_dev_page .nav-tab-new-file').click(function() {
		$.post(ajaxurl, {action: "pp_custom_css_js_dev_create_file", type: $(this).find('.new-file-type').html().toLowerCase()})
			.done(function(data) {
				if (data.success) {
	...
	$('#pp-custom-css-js-dev-delete-btn').click(function() {
		if (typeof 'pp_custom_css_js_dev_file' == 'undefined' || !confirm('Are you sure that you want to delete "' + pp_custom_css_js_dev_file + '"?'))
			return;
		$.post(ajaxurl, {action: "pp_custom_css_js_dev_delete_file", mode: pp_custom_css_js_dev_mode, file: pp_custom_css_js_dev_file})
			.done(function(data) {
				if (data.success) {
	...
	$('#pp-custom-css-js-dev-download-btn').click(function() {
		$('#pp-custom-css-js-dev-iframe').attr('src', ajaxurl + '?action=pp_custom_css_js_dev_download_file&rev=' + pp_custom_css_js_dev_rev);
	});
	
	$('#pp-custom-css-js-dev-download-all-btn').click(function() {
		$('#pp-custom-css-js-dev-iframe').attr('src', ajaxurl + '?action=pp_custom_css_js_dev_download_all&mode=' + pp_custom_css_js_dev_mode);
	});
	
	$('#pp-custom-css-js-dev-upload-btn').click(function() {
		$(this).parent().attr('action', ajaxurl);
		for (file in pp_custom_css_js_dev_data) {
			if (pp_custom_css_js_dev_data[file].unsaved) {
	...
	$('#pp-custom-css-js-dev-rename-btn').click(function() {
		...
		$.post(ajaxurl, {action: "pp_custom_css_js_dev_rename", file: pp_custom_css_js_dev_file, mode: pp_custom_css_js_dev_mode, new_name: $('#pp-custom-css-js-dev-rename-field').val()})
			.done(function(data) {
				if (data.success) {
	...
	$('#pp-custom-css-js-dev-tinymce-cb').change(function() {
		if (typeof 'pp_custom_css_js_dev_file' == 'undefined')
			return;
		$.post(ajaxurl, {action: 'pp_custom_css_js_dev_set_props', mode: pp_custom_css_js_dev_mode, file: pp_custom_css_js_dev_file, props: {'tinymce': ($(this).is(':checked') ? 1 : 'null')}})
			.done(function(data) {
				if (!data.success) {
	...
	function pp_custom_css_js_dev_update_revisions() {
		...
		var revs = pp_custom_css_js_dev_data[pp_custom_css_js_dev_file].revisions;
	...
	function pp_custom_css_js_dev_save(theFile, successAction, failAction) {
		$.post(ajaxurl, {action: "pp_custom_css_js_dev_save", file: theFile, mode: pp_custom_css_js_dev_mode, code: pp_custom_css_js_dev_data[theFile].content})
			.done(function(data) {
				if (data.success) {
