<?php
/** This code is copied from EDD Software Licensing Sample Plugin by Pippin Williamson, GPLv2 or later **/

// this is the URL our updater / license checker pings. This should be the URL of the site with EDD installed
define( 'PP_CCJDEV_STORE_URL', 'https://potentplugins.com/' ); // you should use your own CONSTANT name, and be sure to replace it throughout this file
