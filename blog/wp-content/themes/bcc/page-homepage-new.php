...
while (have_posts()) :
	...
	<section class="services">
		<div class="container">
			<div class="tabs">
				<nav>
					<a class="icon1">Business Energy</a>
					<a class="icon2">Business Waste</a>
					<a class="icon3">Card Payments</a>
					<a class="icon4">Digital Marketing</a>
					<a class="icon5">Business Loan</a>
					<a class="icon6">GDPR Toolkit</a>
					...
					<div class="row">
						<div class="col-md-6">
							...
							<div class="button-wrapper">
								<a href="/business-energy-quoter-n/" class="green-button">Get A Quote</a>
							</div>
						</div>
						<div class="col-md-6 col-energy">
							...
							<a href="https://uk.trustpilot.com/review/businesscostcomparison.co.uk" target="_blank"><img src="<?php echo $domain; ?>/wp-content/uploads/2019/03/trust-pilot.png" alt="Trustpilot Logo"></a>
						</div>
					</div>
				</div>
				<!-- Business Waste Tab -->
				<div class="content">
					<div class="row">
						<div class="col-md-6">
							...
							<div class="bullets">
								<ul>
									<li>We compare 200+ waste suppliers</li>
									<li>Fast, Simple & Convenient</li>
									<li>We do it all</li>
								</ul>
							</div>
				...
				<div class="content">
					<div class="row">
						...
						<div class="col-md-6 col-energy">
							<p>Quick efficient and the company recommended contacted me quickly, the staff were friendly and efficient</p>
							<p style="color: white;">Anne from Yorkshire</p>
				...
				<div class="content">
					<div class="row">
						<div class="col-md-6">
							...
							<div class="button-wrapper">
								<a href="/business-marketing-quoter/" class="green-button">Get A Quote</a>
							</div>
						</div>
						<div class="col-md-6 col-waste">
				...
				<div class="content">
					<div class="row">
						<div class="col-md-6">
							...
							<div class="bullets">
								<ul>
									<li>Borrow from £3,500 to £150,000+</li>
									<li>Pay back little and often</li>
									<li>Unsecured business loans available for all credit scores</li>
									<li>Personal Touch & UK Support from our finance partner Capify</li>

								</ul>
							</div>

							<div class="button-wrapper">
								<a href="/business-loans-form/" class="green-button">Check your Eligibility!</a>
							</div>
						</div>
						<div class="col-md-6 col-energy">
				...
				<div class="content">
					<div class="row">
						<div class="col-md-6">
							<h3>Still not GDPR Compliant?</h3>
							<div class="bullets">
								<ul>
									<li>DIY Downloadable GDPR Toolkit</li>
									<li>Complete pack of templates & guide</li>
									<li>Save on large consultancye fees</li>
									<li>Developed by GDPR Specialists</li>
									<li>Cheapest online from a trusted partner!</li>
								</ul>
							</div>
							<div class="button-wrapper">
								<a href="https://wecomplyit.com/gdpr-templates/" class="green-button">Get Your GDPR Toolkit</a>
							</div>
						</div>
						<div class="col-md-6 col-energy">
							<p>We just signed a contract and everything was really nice and professional</p>
							<p style="color: white;">Andrew T</p>
							<a href="https://uk.trustpilot.com/users/5bfbbdb1fb3cc3135851f148" target="_blank"><img src="<?php echo $domain; ?>/wp-content/uploads/2019/03/trust-pilot.png" alt="Trustpilot Logo"></a>
						</div>
					</div>
				</div>
			</div>
	...
	<section class="mobile-accordion">
		<dl class="accordion">
			...
			<!-- Business Loan Tab -->
			<dt class="tab5"><a href="">Business Loans</a></dt>
			<dd>
				<h3>Need a Business Loan?</h3>
				<div class="bullets">
					<ul>
				...
				<div class="accordion-mob-bgr mob-bgr-waste">
					<h3>Check your eligibility today!</h3>
					<div class="button-wrapper">
						<a href="/business-loans-form/" class="green-button">Get Funds!</a>
					</div>
				</div>
			</dd>

			<!-- GDPR Toolkit Tab -->
			<dt class="tab6"><a href="">GDPR Toolkit</a></dt>
			<dd>
				<h3>Still not GDPR Compliant?</h3>
				<div class="bullets">
					<ul>
						<li>DIY Downloadable GDPR Toolkit</li>
						<li>Complete packof templates & guide</li>
						<li>Save on large consultancy fees</li>
						<li>Developed by GDPR specialists</li>
						<li>Cheapest online from a trusted partner!</li>
				...
				<div class="accordion-mob-bgr mob-bgr-waste">
					<h3>Get your GDPR Toolkit</h3>
					<div class="button-wrapper">
						<a href="https://wecomplyit.com/gdpr-templates/" class="green-button">GET TOOLKIT!</a>
					</div>
				</div>
			</dd>
			...
			<div class="row text-center">
				<div class="col-md-4">
					<div class="counter">
						...
						<h2 class="timer count-title count-number" data-to="5000" data-speed="2000">15,000+</h2>
				...
				<div class="col-md-4">
					<div class="counter">
						<p><i class="fas fa-check-circle fa-3x"></i></p>
						<h2 class="timer count-title count-number" data-to="40" data-speed="2000">40</h2>
				...
				<div class="col-md-4">
					<div class="counter">
						<p><i class="fas fa-check-circle fa-3x"></i></p>
						<h2 class="timer count-title count-number" data-to="20000" data-speed="2000">20000</h2>
