...
<body <?php body_class(); ?>>
	...
	<?php if (!is_page_template('page-home.php')) : ?>
		<div class="top-bar">
			<p>
				<strong>Free Quote</strong><a href="tel:03333447476"> 0333 344 7476</a>
			</p>
		</div>
		...
		<header>
			<div class="menu container">
				...
				<div class="phone col-md-6 offset-md-2">
					<p>
						<a href="tel:03333447476">Free Quote: <strong class="text-primary">0333 344 7476</strong></a>
					</p>
				</div>-->
				</div>
			</div>
			...
			<!--Navbar Main Menu -->
			<?php if (is_page_template(array('page-quote.php', 'page-product.php', 'page-category.php'))) : ?>
					...
					<div class="container">
						<div class="row top-header-usps">
							<div class="col-xs-12 col-md-4 usp-block">
								<div class="row usp-block-row">
									<div class="col-3 usp-block-icon">
										<img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/icon-compare.svg" alt="Compare" class="block-img img-responsive" width="40" height="40">
									</div>
							...
							<div class="col-xs-12 col-md-4 usp-block">
								<div class="row usp-block-row">
									<div class="col-3 usp-block-icon">
										<img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/icon-contract.svg" alt="5000 Contracts Fulfilled" class="block-img img-responsive" width="40" height="40">
									</div>
							...
							<div class="col-xs-12 col-md-4 usp-block">
								<div class="row usp-block-row">
									<div class="col-3 usp-block-icon">
										<img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/icon-uk-coverage.svg" alt="National coverage" class="block-img img-responsive" width="40" height="40">
									</div>
