...
//BEGIN SEND LEAD TO ZAPIER FOR NATIONWIDE
/*	
$curl = curl_init();

$post_data = array
  (
  'leadReference' => 'BCC-'.$llnow,
  'leadCompany' => $nrg_company,
  'leadPostcode' => $nrg_postcode,
  'leadFirstName' => $nrg_first_name,
  'leadLastName' => $nrg_last_name,
  'leadPhone' => $nrg_phone,
  'leadEmail' => $nrg_email,
  'leadQAs' => array(
 'Product: '.$nrg_question1,
 'Supplier: '.$nrg_question2,
 'Bill: ' .$nrg_bill,
...
curl_setopt_array($curl, array(
  CURLOPT_URL => "https://www.energyfalcon.com/api/leads",
  ...
  CURLOPT_HTTPHEADER => array(
    "Authorization: Basic cHVzaGdyb3VwQHByb2R1Y3Rpb246NDQ0ODg1NzAyMTIwMjM3MTYzMjQ0ODEz",
