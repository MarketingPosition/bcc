			...
			<div class="form-holder">
				...
				<div class="step-lead-holder">
					...
					<div class="step-lead-row">
						...
						<form id="nrg_form" class="step-lead-form" action="/thank-you-energy-stevens" method="POST" onsubmit="return check(this)">
							...
							<fieldset class="step-lead-item" id="nrg_step5" style="display: none;">
								...
								<div class="step-lead-flex">
									...
									<div class="step-lead-action">
										<button class="step-lead-btn next-btn" type="submit" data-step="7" >Get Quote!</button>
							...
							<script>
								...
								var tracking_cookie_bcc = window.localStorage.getItem('_ca_history');
								
								var sessions = JSON.parse(window.localStorage.getItem('_ca_history')).sessions;
								...
								var outref      = parsedStr.GAReferrer || 'null';
								var outSource   = parsedStr.utm_source || 'null';
								var outTerm     = parsedStr.utm_term || 'null';
