...
<style>
    ...
    .page-id-1675 ul.checked-list {
        padding-left: 50px;
        list-style: none;
        line-height: 1.4;
    }

    .page-id-1675 ul.checked-list li {
        position: relative;
        font-size: 16px;
        margin-bottom: 30px;
    }

    .page-id-1675 ul.checked-list li:before {
        content: '\f00c';
    ...
    .page-id-1675 ul.checked-list.has-title li:before {
        top: 10px;
    }

    .page-id-1675 ul.checked-list li .title {
        font-size: 20px;
        color: #00a853;
        margin-bottom: 5px;
    }
    ...
    .page-id-1675 .native-form {
        background-image: url('<?php echo $domain; ?>/wp-content/uploads/2019/04/bcc-energy-top-banner.jpg');
    }

    .page-id-1675 .native-form #nrg_quoteform .container {
        padding: 0;
    }

    .page-id-1675 .native-form .quote-2 .bullet-holder {
        padding: 0;
    }

    .page-id-1675 .native-form .quote-2 .bullet-holder h1 {
        font-size: 1.25em;
        font-weight: 300;
        margin-bottom: 50px;
    }

    .page-id-1675 .native-form .step-lead-header {
        position: relative;
        border-radius: 0;
        margin-top: 30px;
    }

    .page-id-1675 .native-form .step-lead-header:before {
    ...
    .page-id-1675 .native-form .step-lead-header p {
        display: none;
    }

    .page-id-1675 .native-form .step-lead-position-item.step-active {
        background-color: #00a853;
    }

    .page-id-1675 .native-form #nrg_step1 .step-lead-action .step-lead-btn.next-btn {
        float: none;
    }

    .page-id-1675 .native-form .step-lead-row {
        border-radius: 0;
        padding-bottom: 15px;
    }
    ...
    .page-id-1675 .supplier-logos-banner {
        padding: 3em 0;
    }

    .page-id-1675 .supplier-logos-banner .supplier-logos-wrapper {
        overflow-x: auto;
    }


    /* Reasons to switch tariff section */
    .page-id-1675 .why-switch-tariffs {
        padding: 3em 0;
    }

    .page-id-1675 .why-switch-tariffs .reasons-to-switch h2 {
        margin-bottom: 1.5em;
    }
    ...
    .page-id-1675 .trust-pilot-widget {
        background-color: #FFF;
        text-align: center;
        border: 1px solid #EEE;
    }

    .page-id-1675 .trust-pilot-widget .header {
        padding: 1em 3em;
    }

    .page-id-1675 .trust-pilot-widget .review-slides {
        position: relative;
        margin: auto;
        padding: 0 0.5em 2em 0.5em;
    }

    .page-id-1675 .trust-pilot-widget .review-slides .slide {
        display: none;
    ...
    .page-id-1675 .trust-pilot-widget .review-slides .slide .quote {
        font-style: italic;
        font-size: 19px;
        height: 130px;
    }

    .page-id-1675 .trust-pilot-widget .review-slides .slide .quote.big-quote {
        font-size: 18px;
    }

    .page-id-1675 .trust-pilot-widget .review-slides .slide .reviewer {
        display: block;
        margin-bottom: 30px;
        color: #00a853;
    }

    .page-id-1675 .trust-pilot-widget .review-slides .dot {
        /*cursor: pointer;*/
        height: 15px;
        width: 15px;
        margin: 0 2px;
    ...
    .page-id-1675 .trust-pilot-widget .review-slides .dot.active {
        background-color: #00a853;
        border: 1px solid #00a853;
    }

    .page-id-1675 .trust-pilot-widget .footer {
        background-color: #499b49;
        padding: 2em 3em;
        color: #FFF;
    }

    .page-id-1675 .trust-pilot-widget .footer .stars {
        margin: 10px 0 8px 0;
    }

    .page-id-1675 .trust-pilot-widget .footer .stars .star {
        display: inline-block;
        padding: 1px 5px;
        background: #3c8348;
    }
    ...
    .page-id-1675 .energy-saving-faqs {
        padding: 3em 0;
        margin-bottom: 60px;
    }

    .page-id-1675 .energy-saving-faqs h2 {
        display: block;
        margin-bottom: 1em;
        padding-bottom: 1em;
    ...
    .page-id-1675 .energy-saving-faqs .faqs-accordion-block .accordion {
        display: -ms-flexbox;
        display: -webkit-box;
        display: flex;
    ...
    .page-id-1675 .energy-saving-faqs .faqs-accordion-block .accordion h3 {
        display: inline-block;
        font-size: 1.25em;
        color: #00a853;
        max-width: 80%;
    ...
    .page-id-1675 .energy-saving-faqs .faqs-accordion-block .accordion .icon {
        display: inline-block;
        position: relative;
        background-color: #00a853;
        color: #FFF;
    ...
    .page-id-1675 .energy-saving-faqs .faqs-accordion-block .accordion .icon:before {
        content: "+";
        position: absolute;
        font-size: 20px;
        top: 2px;
    ...
    .page-id-1675 .energy-saving-faqs .faqs-accordion-block .accordion.active .icon:before {
        content: "-";
        top: -4px;
        left: 14px;
        font-size: 26px;
    ...
    .page-id-1675 .energy-saving-faqs .faqs-accordion-block .accordion.active .icon,
    .page-id-1675 .energy-saving-faqs .faqs-accordion-block .accordion:hover .icon {
        background-color: #000b69;
    }

    .page-id-1675 .energy-saving-faqs .faqs-accordion-block .panel {
        display: none;
    ...
    .page-id-1675 .energy-saving-faqs .faqs-accordion-block .panel p {
        font-size: 16px;
    }

    .page-id-1675 .energy-saving-faqs .faqs-accordion-block .panel a {
        color: #00a853;
        text-decoration: underline;
    }

    .page-id-1675 .energy-saving-faqs .faqs-accordion-block .accordion-block {
        border-bottom: 1px solid #EEE;
    }

    .page-id-1675 .energy-saving-faqs .faqs-accordion-block .accordion.active+.panel {
        display: block !important;
    }

    /* Bottom energy CTA banner */
    .page-id-1675 .bottom-energy-cta-banner {
        padding: 6em 0;
    ...
    .page-id-1675 .bottom-energy-cta-banner .text-overlay {
        text-align: center;
    }

    .page-id-1675 .bottom-energy-cta-banner .text-overlay h3 {
        max-width: 580px;
        color: #FFF;
    ...
    .page-id-1675 .bottom-energy-cta-banner .text-overlay .btn {
        font-size: 16px;
    ...
    @media(min-width: 768px) {
        ...
        /* Top hero section with form */
        .page-id-1675 .native-form .quote-2 .bullet-holder ul li {
            font-size: 18px;
            margin-bottom: 15px;
        }
        ...
        /* Trust pilot widget */
        .page-id-1675 .trust-pilot-widget-bg {
    ...
    @media(min-width: 992px) {
        ...
        .page-id-1675 .native-form .step-lead-header h1 {
            padding: 0 2.5em;
        }
        ...
        /* Supplier logos banner section */
        .page-id-1675 .supplier-logos-banner .supplier-logos-wrapper img {
            max-width: 100%;
            height: auto;
        }
        ...
        /* Reasons to switch tariff section */
        .page-id-1675 .why-switch-tariffs .reasons-to-switch {
            padding: 3em;
        }
    ...
    <div class="container quote-2">
        <div class="row align-items-lg-center">
            <div class="col-lg-6 order-lg-2">
                <?php get_template_part('template-parts/block', 'SMARTERform1'); ?>
            </div>
...
<script>
    // Top hero section with form
    var energyQuoteFormTitle = document.querySelector('.page-id-1675 .step-lead-header h1');
    var formStepBtns = document.querySelectorAll('.page-id-1675 .step-lead-position a');
    var firstNextStepFormBtn = document.querySelector('.page-id-1675 #nrg_step1 .step-lead-action a.step-lead-btn.next-btn');
    ...
    //     var i;
    //     var slides = document.querySelectorAll(".page-id-1675 .review-slides .slide");
    //     var dots = document.querySelectorAll(".page-id-1675 .review-slides .dot");
