<section id="nrg_quoteform" class="native-form" style="background: none;">
		<div class="container" >
			...
			<div class="form-holder">
				...
				<div class="step-lead-holder">
					...
					<div class="step-lead-row">
						...
						<form id="nrg_form" class="step-lead-form" action="/thank-you-energy-s" method="POST" onsubmit="return check(this)">
								...
								<div class="step-lead-flex">
									...
									<label class="step-lead-input " style="margin-bottom:0.5rem;background-color:#f4f4f4;">
										<div>
											...
											<input type="text" id="nrg_email" name="nrg_email" onkeyup="emailVal()" required/>
