...
/**
 * Instant price waste form with business type option on step 5 of the form.
 *
 * @package bcctheme
 */
...
<style>
	...
	#quoteform.native-form .step-lead-flex .step-lead-input:last-child {
		background-color: #f4f4f4;
	}

	#quoteform.native-form .step-lead-input.has-error select {
		border-color: #d87070;
	}
</style>
