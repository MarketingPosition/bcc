...
$loans_question1      = $_POST["mkt_question1"];
$loans_question2      = $_POST["mkt_question2"];
$loans_question3      = $_POST["mkt_question3"];
$loans_question4      = $_POST["mkt_question4"];

$nrg_first_name     = $_POST["mkt_first_name"];
$nrg_last_name      = $_POST["mkt_last_name"];
$nrg_company        = $_POST["mkt_company"];
$nrg_phone          = $_POST["mkt_phone"];
$nrg_postcode       = $_POST["mkt_postcode"];
$nrg_email          = $_POST["mkt_email"];
...
$bccapi = "lns_question1=" . $loans_question1 .
	"&lns_question2=" . urlencode($loans_question2) .
	"&lns_question3=" . urlencode($loans_question3) .
	"&lns_question4=" . urlencode($loans_question4) .
...
curl_setopt_array($curl, [
	CURLOPT_RETURNTRANSFER => 1,
	CURLOPT_URL => 'http://35.211.186.221/api-loans-v2.php?' . $bccapi,
	CURLOPT_USERAGENT => 'Codular Sample cURL Request'
]);
// Send the request & save response to $resp
$resp = curl_exec($curl);
