      ...
      <div class="container">
        <div class="w-75 mx-auto mb-5 text-center">
          <div class="thank-you-message bg-primary p-5">
            <h2 class="card-title text-white">Thank You</h2>
            <p class="text-white mb-0">
              Once we have verified your details, our recommended partner will
              <span class="d-lg-block">call you within the hour to discuss your requirements.</span>
            </p>
          </div>
        </div>
