...
<body>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-8 mx-auto">
            <form id="pform" action="<?php echo $domain; ?>/form/lead-energy2.php" method="post">
              ...
              <input type="hidden" name="redirect_url" value="<?php echo $domain; ?>/business-energy2/thank-you/" />

              <div class="pform-title">
                <h2>Search The Market For Business Energy Quotes</h2>
  ...
  <script src="<?php echo $domain; ?>/assets/js/utm_form-1.3.0.min.js" defer></script>
