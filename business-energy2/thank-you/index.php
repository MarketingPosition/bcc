...
$page_name = "Business Energy - Business Cost Comparison";
$section_name = "";
$page_description = "";
        ...
        <div class="row">
          <div class="col-12 col-lg-8 mx-auto text-center">
            <div class="thank-you-message">
              ...
              <p>
                As Business Energy is a very complex industry we may require
          ...
          <div class="card text-center bg-light mb-4">
            <div class="card-body py-5">
              ...
              <p class="card-text mb-0">
                Bring yourself up to date and offer contactless payments in
                your business
              </p>
